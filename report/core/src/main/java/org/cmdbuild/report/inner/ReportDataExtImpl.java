...
//    private final List<JasperDesign> jasperDesigns;
...
//        this.jasperDesigns = ImmutableList.copyOf(builder.jasperDesigns);
        checkArgument(inner.hasCompiledReports() && inner.hasSourceReports());
//        checkArgument(!jasperReports.isEmpty() && jasperReports.size() == jasperDesigns.size() && jasperReports.size() == inner.getCompiledReports().size() && jasperReports.size() == inner.getSourceReports().size());
...
//                .withJasperDesigns(source.getJasperDesigns());
    }
...
//        private List<JasperDesign> jasperDesigns;
...
//        public ReportDataExtImplBuilder withJasperDesigns(List<JasperDesign> jasperDesigns) {
//            this.jasperDesigns = jasperDesigns;
//            return this;
//        }
