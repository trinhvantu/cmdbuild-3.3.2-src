            ...
            public int complete(String buffer, int cursor, List<CharSequence> candidates) {
                ...
                try {
                    ...
                    if (matcher.matches()) {
                        ...
                        if (context.get() instanceof IfcEntry) {
                            ((IfcEntry) context.get()).getFeatures().keySet().stream().filter(c -> c.startsWith(part)).sorted().forEach(candidates::add);
                        } else {
                    ...
                    try {
                        ...
                        if (matcher.find()) {
                            ...
                            list.forEach(rethrowConsumer(e -> {
                                if (e instanceof IfcEntry) {
                                    IfcEntry entry = (IfcEntry) e;
