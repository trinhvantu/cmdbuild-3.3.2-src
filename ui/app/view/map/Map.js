Ext.define('CMDBuildUI.view.map.Map', {
    ...
    onHashMapUpdate: function (hash, keyValues) {
        ...
        if (featureStore && shapefeatureStore) {
            ...
            for (var key in keyValues) {
                ...
                do {
                    ...
                    if (geovalueindex != -1) {
                        ...
                        if (olMap) {
                            ...
                            console.log('should be present olMap');
                        }
                    }
                ...
                do {
                    shapefeatureindex = shapefeatureStore.find('owner_id', key, ++shapefeatureindex);
            ...
            console.log('should be present featureStore');
        }
    },
