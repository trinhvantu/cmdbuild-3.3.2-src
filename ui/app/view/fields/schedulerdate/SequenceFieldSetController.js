    ...
    privates: {
        ...
        generateEvent: function (sequence) {
            return Ext.create('CMDBuildUI.model.calendar.Event', {
                ...
                // _notification__id: sequence.get('_notification__id'),
                _notification_template: sequence.get('_notification_template'),
                _notification_content: sequence.get('_notification_content'),
                _notification_delay: sequence.get('_notification_delay'),
