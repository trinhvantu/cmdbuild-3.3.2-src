Ext.define('CMDBuildUI.view.administration.content.emails.templates.card.ViewInRow', {
    ...
    items: [
        CMDBuildUI.view.administration.content.emails.templates.card.FieldsHelper.getGeneralPropertyFieldset('viewinrow'),
        CMDBuildUI.view.administration.content.emails.templates.card.FieldsHelper.getTemplateFieldset('viewinrow')
    ],
