Ext.define('CMDBuildUI.view.administration.content.dms.models.tabitems.properties.fieldsets.ContextMenusFieldset', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.administration-content-dms-models-tabitems-properties-fieldsets-contextmenusfieldset',
    controller: 'administration-content-dms-models-tabitems-properties-fieldsets-contextmenusfieldset',
    ...
    items: [{
        ...
        items: [{
            ...
            items: [{
                ...
                bind: {
                    store: '{theModel.contextMenuItems}'
                },
                columnWidth: 0.5,
                            ...
                            listeners: {
                                afterrender: function (cmp) {
                                    ...
                                    editor.getSession().on('change', function (event, _editor) {
                                        var vm = me.up('administration-content-dms-models-tabitems-properties-fieldsets-contextmenusfieldset').getViewModel().getParent();
