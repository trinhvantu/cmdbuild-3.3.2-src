...
Ext.define('CMDBuildUI.view.administration.content.dashboards.card.builder.Column', {
    ...
    initComponent: function () {
        this.tpl = new Ext.XTemplate('<tpl for=".">',
            ...
            // '<div style="width:100%; min-width:150px; overflow: hidden; text-overflow: ellispis; white-space: nowrap" class="attribute-source x-unselectable" data-testid="administration-content-dashboards-card-builder-chart-column">',
            ...
            '<span>{[this.getIcon(values)]} {[this.getChartType(values)]}</span>',

            '<tpl if="this.isEditMode()">',
            '<span class="draggable-tool" style="position:absolute;right: 90px;"><div id="{[this.getToolId(values._id,\'edit\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'edit\')]}"><div data-event="edit" data-ref="toolEl" class="x-tool-tool-el x-tool-tool-el x-fa fa-pencil"></div></div></span>',
            '<span class="draggable-tool" style="position:absolute;right: 70px;"><div id="{[this.getToolId(values._id,\'open\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'open\')]}"><div data-event="open" data-ref="toolEl" class="x-tool-tool-el x-tool-tool-el x-fa fa-external-link "></div></div></span>',
            '<tpl if="!this.isChartDisabled(values)">',
            '<span class="draggable-tool" style="position:absolute;right: 50px;"><div id="{[this.getToolId(values._id,\'disable\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'disable\')]}"><div data-event="disable" data-ref="toolEl" class="x-tool-tool-el x-tool-tool-el x-fa fa-ban "></div></div></span>',
            '<tpl else>',
            '<span class="draggable-tool" style="position:absolute;right: 50px;"><div id="{[this.getToolId(values._id,\'enable\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'enable\')]}"><div data-event="enable" data-ref="toolEl" class="x-tool-tool-el x-tool-tool-el x-fa fa-check-circle-o"></div></div></span>',
            '</tpl>',
            '<span class="draggable-tool" style="position:absolute;right: 30px;"><div id="{[this.getToolId(values._id,\'clone\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'clone\')]}"><div data-event="clone" data-ref="toolEl" class="x-tool-tool-el x-tool-tool-el x-fa fa-clone  "></div></div></span>',
            '<span class="draggable-tool" style="position:absolute;right: 10px;"><div id="{[this.getToolId(values._id,\'delete\')]}" class="x-tool administration-tool" aria-disabled="false" data-qtip="{[this.getQtip(\'delete\')]}"><div data-event="delete" data-ref="toolEl" class="x-tool-tool-el x-tool-tool-el x-fa fa-trash "></div></div></span>',
            '</tpl>',
            '</div></td>',
            '</tr>',
            '<tr>',
            // '<td>',
            // '<span style="flex-direction: row; flex: 1;overflow: hidden; text-overflow: ellispis; white-space: nowrap">{[this.getDescription(values)]}</span>',
            // '</td>',
            '</tr>',
            '</tbody>',
            '</table>',
