Ext.define('CMDBuildUI.view.administration.content.dashboards.card.chart.FormModel', {
    ...
    stores: {
        dataSourceTypeStore: {
            ...
            data: CMDBuildUI.model.dashboards.Chart.getDataSourceTypes(),
        ...
        integerFieldTypesStore: {
            model: 'CMDBuildUI.model.base.ComboItem',
            data: CMDBuildUI.model.dashboards.DataSourceParameter.getIntegerFieldTypes(),
        ...
        stringFieldTypesStore: {
            model: 'CMDBuildUI.model.base.ComboItem',
            data: CMDBuildUI.model.dashboards.DataSourceParameter.getStringFieldTypes(),
            //  autoDestroy: true, // if true the ui will break
            autoLoad: true,
            proxy: {
                type: 'memory'
        ...
        chartOrientationStore: {
            model: 'CMDBuildUI.model.base.ComboItem',
            data: CMDBuildUI.model.dashboards.Chart.getChartOrientations(),
            // autoDestroy: true, // if true the ui will break
            autoLoad: true,
            proxy: {
                type: 'memory'
