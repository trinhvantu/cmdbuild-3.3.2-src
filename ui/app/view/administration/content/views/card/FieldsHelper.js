            ...
            items: [
                CMDBuildUI.util.administration.helper.FieldsHelper.getAllClassesInput({
                    sourceClassName: {
                        ...
                        displayfield: {
                            bind: {
                                value: '{theViewFilter._sourceClassName_description}'
                            }
                        },
                        combofield: {
                            listeners: {
                                // use the same function of remove filter button
                                ...
                                render: function (combo, e, eOpts) {
                                    var setHidden = combo.lookupViewModel().get('theViewFilter.type') !== CMDBuildUI.model.views.View.types.filter;
                                    CMDBuildUI.util.administration.helper.FieldsHelper.setAllowBlank(combo, setHidden, combo.up('form'));
                                }
                            },
                            bind: {
