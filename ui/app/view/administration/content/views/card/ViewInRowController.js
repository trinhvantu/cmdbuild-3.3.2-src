    ...
    onToggleActiveBtnClick: function (button, e, eOpts) {
        ...
        theViewFilter.save({
            success: function (record, operation) {
                ...
                // view.up('administration-content-views-grid').getPlugin('administration-forminrowwidget').view.fireEventArgs('togglerow', [null, record.getStore(), vm.get('recordIndex')]);  
            },
