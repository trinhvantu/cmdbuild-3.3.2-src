Ext.define('CMDBuildUI.view.administration.content.localizations.exports.ViewController', {
    ...
    onLaguagesStoreLoad: function (store) {
        var grid = this.lookup('activelanguagesgrid');
    ...
    onExportButtonClick: function (button, e, eopts) {
        ...
        var encodedRequest = encodeURI(Ext.String.format('{0}/translations/export?section={1}&languages={2}&format={3}&separator={4}&activeonly={5}&includeRecordsWithoutTranslation=true',
