    ...
    generateMenu: function (view) {
        ...
        view.lookupViewModel().bind({
            ...
            root.appendChild({
                ...
                allowDrag: false,
                expanded: false,
                children: me.generateChildren(viewsItems, CMDBuildUI.model.menu.MenuItem.types.view)
            });
            ...
            root.appendChild({
                ...
                children: me.generateChildren(Ext.Array.filter(custompagesItems, function (custompage) {
                    if (view.lookupViewModel().get('theMenu.device') === CMDBuildUI.model.menu.Menu.device['default']) {
                        return custompage.get('device') === CMDBuildUI.model.custompages.CustomPage.device['default'];
                    } else {
                        return custompage.get('device') === CMDBuildUI.model.custompages.CustomPage.device.mobile;
                    }
