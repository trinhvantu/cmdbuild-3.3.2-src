                        ...
                        targetName: {
                            ...
                            listeners: {
                                change: function (input, newValue, oldValue) {
                                    var vm = this.lookupViewModel();
                                    var obj = CMDBuildUI.util.helper.ModelHelper.getObjectFromName(newValue);
                                    if (obj) {
                                        ...
                                        obj.getAttributes(true).then(
                                            function (attributeStore) {
                                                var attributes = Ext.Array.filter(attributeStore.getRange(), function (item) {
                                                    return item.get('active') && item.canAdminShow();
                                                });
                                                if (!vm.destroyed) {
                ...
                columns: [{
                    ...
                    items: [{
                        ...
                        handler: function (grid, rowIndex, colIndex) {
                            ...
                            var record = store.getAt(rowIndex);
                            store.remove(record);
                            // if (vm.get('theGateTemplate.importKeyAttribute') === record.get('attribute')) {
                            //     vm.set('theGateTemplate.importKeyAttribute', null);
                            // }
                            ...
                            if (me.getStore() && me.getStore().source) {
                                ...
                                if (allAttrStore.getRange()) {
                                    me.getStore().addFilter(function (item) {
                                        ...
                                        if (isSelected) {
                                            vm.getParent().manageDataFormatFieldset(item);
                                        }
                                        return item.canAdminShow( /*allowedAttributes*/ ['IdTenant', 'Notes']) && !isSelected;
                                    });
                                }
                            }
                        },
                            ...
                            change: function (combo, newValue, oldValue) {
                                ...
                                if (allAttributes && allAttributes.getData().length) {
                                    ...
                                    if (attribute) {
                                        ...
                                        if (['lookup', 'reference'].indexOf(attribute.get('type')) > -1) {
        ...
        return {
            ...
            items: [
                        ...
                        },
                        {
                            ...
                            columns: [{
                                ...
                                items: [{
                                    ...
                                    getClass: function (value, metadata, record, rowIndex, colIndex, store) {
                                        metadata.value = Ext.String.insert(metadata.value, ' data-testid="administration-importexport-attributekey-addBtn"', -7);
                                        return 'x-fa fa-plus';
                                    },
                                    ...
                                    handler: function (grid, rowIndex, colIndex) {
                                        ...
                                        keyAttributes.push(grid.down('#selectKeyAttributeForGrid').getValue());
                                        vm.set('theGateTemplate._importKeyAttribute', keyAttributes.join(','));
                                        grid.down('#selectKeyAttributeForGrid').clearValue();
                                        Ext.resumeLayouts();
                ...
                this.createContainer([
                    ...
                    // autoLoad                
                    CMDBuildUI.util.administration.helper.FieldsHelper.getCommonCheckboxInput('alwaysHandleMissingRecords', {
                        alwaysHandleMissingRecords: {
                            fieldcontainer: {
                                fieldLabel: CMDBuildUI.locales.Locales.administration.importexport.fieldlabels.alwayshandlemissingrecords,
                                localized: {
                                    fieldLabel: 'CMDBuildUI.locales.Locales.administration.importexport.fieldlabels.alwayshandlemissingrecords'
                                },
                                hidden: true,
                            ...
                            bind: {
                                ...
                                value: '{theGateTemplate.alwaysHandleMissingRecords}'
                            }
                        }
                    })
                ]),
    ...
    getErrorsManagementFieldset: function () {
        return {
            ...
            items: [{
                ...
                layout: 'column',
                columnWidth: 1,
                items: [CMDBuildUI.util.administration.helper.FieldsHelper.getCommonComboInput('errorEmailTemplate', {
                    errorEmailTemplate: {
                        ...
                        combofield: {
                            bind: {
                                store: '{errorEmailTemplates}',
                                value: '{theGateTemplate.errorEmailTemplate}'
                            }
                        },
                        displayfield: {
                            bind: {
                                value: '{theGateTemplate._errorEmailTemplate_description}'
                            },
                            renderer: function (value) {
                                var me = this;
                                var vm = me.lookupViewModel();
                                vm.bind({
                                    ...
                                    if (!vm.destroyed && !Ext.isEmpty(data.value) && data.store) {
                                        var record = data.store.getById(data.value) || vm.get('errorEmailTemplates').getById(data.value);
                                        if (record) {
                                            vm.set('theGateTemplate._errorEmailTemplate_description', record.get('description'));
                                        }
                                    }
                                });
                                return value;
                    ...
                    errorEmailAccount: {
                        ...
                        bind: {
                            ...
                            value: '{theGateTemplate.errorEmailAccount}'
                        },
                        triggers: {
                            clear: CMDBuildUI.util.administration.helper.FormHelper.getClearComboTrigger()
                        },
                        displayfield: {
                            ...
                            renderer: function (value) {
                                ...
                                vm.bind({
                                    ...
                                    if (!vm.destroyed && !Ext.isEmpty(data.value) && data.store) {
                                        var record = data.store.getById(data.value);
                                        if (record) {
                                            vm.set('theGateTemplate._errorEmailAccount_description', record.get('description'));
                                        }
                                    }
                                });
                                return value;
                ...
                columnWidth: 1,
                items: [
                    CMDBuildUI.util.administration.helper.FieldsHelper.getCommonComboInput('notificationEmailTemplate', {
                        notificationEmailTemplate: {
                            fieldLabel: CMDBuildUI.locales.Locales.administration.importexport.texts.notificationemailtemplate,
                            fieldcontainer: {
                                columnWidth: 0.5
                            },
                            allowBlank: true,
                            ...
                            combofield: {
                                bind: {
                                    ...
                                    value: '{theGateTemplate.notificationEmailTemplate}'
                                }
                            },
                            bind: {},
                            displayfield: {
                                ...
                                renderer: function (value) {
                                    ...
                                    vm.bind({
                                        ...
                                        if (!Ext.isEmpty(data.value) && data.store) {
                                            var record = data.store.getById(data.value);
                                            vm.set('theGateTemplate._notificationEmailTemplate_description', record.get('name'));
                                        } else {
