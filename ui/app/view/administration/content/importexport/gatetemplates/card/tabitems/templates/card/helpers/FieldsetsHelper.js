            ...
            items: [{
                    ...
                    columns: [{
                            ...
                            editor: {
                                ...
                                listeners: {
                                    beforerender: function (combo) {
                                        ...
                                        if (attribute && (['lookup', 'reference'].indexOf(attribute.get('_subtype')) > -1) || record.get('columnName') === 'CM_RELATIVE_LOCATION') {
                            ...
                            renderer: function (value, cell, record, rowIndex, colIndex, store, grid) {
                                ...
                                if (!value && attribute && ['lookup', 'reference'].indexOf(attribute.get('_subtype')) > -1) {
                    ...
                    columns: [{
                            ...
                            widget: {
                                ...
                                setInputPresets: function (attribute) {
                                    ...
                                    if (['lookup', 'reference'].indexOf(attribute.get('_subtype')) > -1) {
                    ...
                    CMDBuildUI.util.administration.helper.FieldsHelper.getCommonComboInput('mergeMode', {
                        mergeMode: {
                            ...
                            bind: {
                                ...
                                disabled: '{theGateTemplate.fileFormat === "cad"}'
                            },
                            fieldcontainer: {
