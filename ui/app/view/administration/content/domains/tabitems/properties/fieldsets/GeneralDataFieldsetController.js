Ext.define('CMDBuildUI.view.administration.content.domains.tabitems.properties.fieldsets.GeneralDataFieldsetController', {
    ...
    onTranslateClickDescription: function (event, button, eOpts) {
        ...
        CMDBuildUI.util.administration.helper.FormHelper.openLocalizationPopup(translationCode, vm.get('action'), 'theDomainDescriptionTranslation', vm.getParent());
    },
    ...
    onTranslateClickDirect: function (event, button, eOpts) {
        ...
        CMDBuildUI.util.administration.helper.FormHelper.openLocalizationPopup(translationCode, vm.get('action'), 'theDirectDescriptionTranslation', vm.getParent());
    },
    ...
    onTranslateClickInverse: function (event, button, eOpts) {
        ...
        CMDBuildUI.util.administration.helper.FormHelper.openLocalizationPopup(translationCode, vm.get('action'), 'theInverseDescriptionTranslation', vm.getParent());
    },
    ...
    onTranslateClickMasterDetail: function (event, button, eOpts) {
        ...
        CMDBuildUI.util.administration.helper.FormHelper.openLocalizationPopup(translationCode, vm.get('action'), 'theMasterDetailTranslation', vm.getParent());
    },
    ...
    resetSummaryGrid: function (combo, newValue, oldValue) {
        if (oldValue) {
            var vm = combo.lookupViewModel();
            vm.set('theDomain.masterDetailAggregateAttrs', []);
            vm.getStore('masterDetailAggregateAttrsStore').removeAll();
        }
