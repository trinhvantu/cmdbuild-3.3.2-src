Ext.define('CMDBuildUI.view.administration.content.groupsandpermissions.tabitems.permissions.components.SimpleGrid', {
    ...
    columns: [{
            ...
            items: [{
                ...
                tooltip: CMDBuildUI.locales.Locales.administration.groupandpermissions.tooltips.manageconfigurations,
                localized: {
                    tooltip: 'CMDBuildUI.locales.Locales.administration.groupandpermissions.tooltips.manageconfigurations'
                },
                getClass: function (v, meta, row, rowIndex, colIndex, store) {
                ...
                tooltip: CMDBuildUI.locales.Locales.administration.groupandpermissions.tooltips.clearconfigurations,
                localized: {
                    tooltip: 'CMDBuildUI.locales.Locales.administration.groupandpermissions.tooltips.clearconfigurations'
                },
                getClass: function (v, meta, row, rowIndex, colIndex, store) {
    ...
    getActionContent: function (formMode, record, grid, rowIndex, fbar) {
        return {
            ...
            items: [{
                ...
                xtype: 'administration-content-groupsandpermissions-tabitems-permissions-components-grantconfig-actions-bulkactionfieldset',
                viewModel: {
                    data: {
                        grant: record,
                        actions: formMode
