Ext.define('CMDBuildUI.view.administration.content.classes.ViewModel', {
    ...
    formulas: {
        ...
        hideParentCombobox: {
            ...
            get: function (data) {
                if (data.type) {
                    return (data.type === 'simple' || data.view) ? true : false;
                }
            }
        },
        ...
        defaultImportExportStoreDataManager: {
            bind: {
                filesTemplatesStore: '{importFileTemplateStore}',
                gateTemplatesStore: '{importGateTemplateStore}'
            },
            get: function (data) {
                var _data = [];
                ...
                if (data.gateTemplatesStore) {
                    data.gateTemplatesStore.each(function (gateTemplate) {
                        var label = '';
                ...
                this.set('defaultImportExportStoreData', _data);
            }
        },

        defaultExportTemplateStoreDataManager: {
            bind: {
            ...
            get: function (data) {
                ...
                this.set('defaultExportTemplateStoreData', _data);
            }
        },
