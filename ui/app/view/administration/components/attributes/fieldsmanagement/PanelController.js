Ext.define('CMDBuildUI.view.administration.components.attributes.fieldsmanagement.PanelController', {
    ...
    onLayoutAutogenBtnClick: function (button, event, eOpts) {
        ...
        Ext.Object.each(form, function (fieldset, rows) {
            ...
            if (fieldsetView) {
                Ext.asap(function () {
                    fieldsetView.down('administration-components-attributes-fieldsmanagement-group-group').fireEvent('autogenerate');
                });
            }
        });
    },
        ...
        processBind: function (view) {
            ...
            vm.bind({
                ...
                if (data.activity) {
                    ...
                    data.activity.attributes().each(function (attribute) {
                        ...
                        if (aDetail) {
                            ...
                            if (!attribute.get('action') && attribute.get('_id') !== theProcess.get('messageAttr') && attribute.get('_id') !== theProcess.get('flowStatusAttr')) {
                                aStore.add(aDetail);
                            }
                        } else {
                            Ext.asap(function () {
        ...
        joinViewsBind: function () {
            ...
            vm.bind({
                ...
                if ((data.theView)) {
                    ...
                    var grid = this.getView().up('joinviews-configuration-configuration').down('joinviews-configuration-items-attributes grid');
