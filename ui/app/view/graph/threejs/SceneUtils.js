        ...
        switch (action) {
            case 'add':
                ...
                if (parentSprite && parentSprite.children) {
                    selectedSprite = parentSprite.children.find(function (item, index, array) {
                    ...
                    case 'relation':
                        ...
                        this.panel.setHtml(
                            Ext.String.format('<div class="relgraph-tip relgraph-tip-relation">{0}: {1}</br><b>{2}</b></br>{3}: {4}</div>',
                                CMDBuildUI.util.helper.ModelHelper.getObjectDescription(config.sourceType),
                                config.sourceDescription,
                                config.isDirect ? config.descriptionDirect : config.descriptionInverse,
                                CMDBuildUI.util.helper.ModelHelper.getObjectDescription(config.destinationType),
