Ext.define('CMDBuildUI.view.graph.GraphContainerController', {
    ...
    */
    ...
    mapNode_2_edges: function (record, id) {
        ...
        var descriptionDirect = domain.get('_descriptionDirect_translation');
        var descriptionInverse = domain.get('_descriptionInverse_translation');
