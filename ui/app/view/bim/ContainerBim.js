...
Ext.define('CMDBuildUI.view.bim.ContainerBim', {
    ...
    mixins: ['CMDBuildUI.view.bim.Mixin'],
    ...
    items: [{ //TODO: Set a maxWidth
        ...
        items: [{
            ...
            bind: {
                selectedId: '{bim-containerbim.selectedId}',
                hiddenNodes: '{bim-containerbim.hiddenNodes}',
                store: '{bim-containerbim.treeStore}'
            }
        }, {
            ...
            bind: {
                ...
                store: '{bim-containerbim.layerStore}'
            }
        }, {
            xtype: 'bim-tab-cards-cards',
        ...
        controller: {
            ...
            onAfterRender: function () {
                var view = this.getView().up('bim-container');
