Ext.define('CMDBuildUI.view.joinviews.configuration.items.DataSortingModel', {
    ...
    formulas: {
        defaultOrders: function () {
            return CMDBuildUI.model.CMDBuildUI.model.views.JoinViewSorter.getDefaultOrders();
        },
        defaultOrderEmptyRecord: function () {
            return Ext.create('CMDBuildUI.model.CMDBuildUI.model.views.JoinViewSorter', {direction: 'ASC'});
        },
        selectblesAtributesFilter: {
            ...
            get: function (storeStore) {
                ...
                return [function (item) {
                    return !storeStore.findRecord('property', item.get('expr'));
                }];
            }
        },
            ...
            get: function (data) {
                ...
                var getData = function (store) {
                    ...
                    Ext.Array.forEach(data.attributes, function (item) {                        
                        if (!data.sorter.findRecord('property', item.get('expr'))) {
    ...
    stores: {
        ...
        defaultOrderStoreNew: {
            model: 'CMDBuildUI.model.CMDBuildUI.model.views.JoinViewSorter',
            autoLoad: true,
            autoDestroy: true,
            proxy: {
                type: 'memory'
