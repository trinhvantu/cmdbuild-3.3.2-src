        ...
        items: [
            {
                ...
                handler: function (button, eOpts) {
                    ...
                    var buttonText = vm.get('activeview'); //using vm.get('buttonText') breaks the activeItem bind

                    switch (buttonText) {
                        case CMDBuildUI.view.events.Container.grid:
                            vm.set('buttonText', CMDBuildUI.view.events.Container.calendar)
                            break;
                        case CMDBuildUI.view.events.Container.calendar:
                            vm.set('buttonText', CMDBuildUI.view.events.Container.grid)
                            break;
                    }
