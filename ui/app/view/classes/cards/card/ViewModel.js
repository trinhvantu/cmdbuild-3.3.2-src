        ...
        updatePermissions: {
            ...
            get: function (data) {
                ...
                if (data.typename) {
                    ...
                    // hidden buttons
                    this.getParent().set("configenabled.relgraph", (!isSimpleClass && configs.get(CMDBuildUI.model.Configuration.relgraph.enabled)));
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function (response) {
                                ...
                                if (jsonResponse.data.exists) {
                                    me.getParent().set('configenabled.bim', true);
                                    me.getParent().set('bim.projectid', jsonResponse.data.projectId);
                                    me.getParent().set('bim.selectedid', jsonResponse.data.globalId);
                                } else {
                                    me.getParent().set('configenabled.bim', false);
                                    me.getParent().set('bim.projectid', null);
                                }
                            }
                        });
                    }
