Ext.define('CMDBuildUI.model.calendar.Trigger', {
    ...
    fields: [{
        ...
        serialize: function (value, record) {            
            return Ext.isEmpty(record.get('notifications___0___template')) ? undefined : -(record.get('_calculated_notification_delay') * 60 * 60 * 24); // set daysAdvanceNotification to negative seconds

        }
    }, {
        name: '_calculated_notification_delay',
        type: 'number',
        calculate: function (data) {
            return Math.abs(data.notifications___0___delay / 60 / 60 / 24); // value should be in seconds
        }
    }, {
        name: 'notifications',
        critical: false,
