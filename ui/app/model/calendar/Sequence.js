Ext.define('CMDBuildUI.model.calendar.Sequence', {
    ...
    fields: [{
        ...
        attributeconf: {
            ...
            autoValue: 'api.bind = ["daysAdvanceNotification"] ; var value = -api.record.get("daysAdvanceNotification") * 60* 60* 24; api.record.set("_notification_delay", value)',
        ...
        convert: function (value, record) {
            return Math.abs(record.get('_notification_delay') / (60 * 60 * 24));
        },
        depends: ['_notification_delay'],
        cmdbuildtype: 'integer',
        persist: false
    }, {
        name: '__firstconvert',
