Ext.define('CMDBuildUI.model.users.Session', {
    ...
    adminCan: function (privilege, serviceToCheck) {
        var rolePrivilege = false,
            privileges = this.get('rolePrivileges');
        if (privileges && privileges[CMDBuildUI.model.users.Session.adminRolePrivileges.admin_access]) {
