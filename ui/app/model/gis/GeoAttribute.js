Ext.define('CMDBuildUI.model.gis.GeoAttribute', {
    ...
    fields: [{
        ...
        calculate: function (data) {
            return Ext.String.format('{0} ({1})', data.name, CMDBuildUI.util.helper.ModelHelper.getObjectDescription(data.owner_type));
        }
    }, {
        name: 'ollayername',
        type: 'string',
    ...
    getOlLayerVectorStyle: function (olFeature, number) {
        ...
        switch (subtype) {
            case CMDBuildUI.model.gis.GeoAttribute.subtype.point:
                ...
                if (olFeature.get('hasBim')) {
                    ...
                    if (this.get('_img')) {
                        //if has bim and icon
                        style.push(this.getOlLayerVectorBaseStyle());
                    }
                } else {
        ...
        if (thematism instanceof CMDBuildUI.model.thematisms.Thematism) {
            //if ther is an applied thematism
    ...
    getOlLayerVectorBaseStyle: function () {
