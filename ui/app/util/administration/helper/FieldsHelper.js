Ext.define('CMDBuildUI.util.administration.helper.FieldsHelper', {
    ...
    privates: {
        ...
        _setTestId: function (config, name) {
            ...
            if (!config.autoEl['data-testid']) {
                config.autoEl['data-testid'] = Ext.String.format('administration-{0}-input', name);
            }
        },
        /**
         * 
                ...
                render: function (element) {
                    ...
                    vm.bind({
                        ...
                        if (data.validationRule) {
                            aceEditor.setValue(data.validationRule);
                        }
                    });
                    vm.bind({
                        isView: '{actions.view}'
    ...
    getCommonComboInput: function (propertyName, config, disabledOnEdit, onlyCombo) {
        ...
        if (!onlyCombo) {
            ...
            fieldcontainer.items.push(this._getDisplayfield(displayConfig, {
