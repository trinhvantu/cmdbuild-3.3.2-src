Ext.define('CMDBuildUI.util.administration.helper.ApiHelper', {
    ...
    client: {
        ...
        getCustomPageUrl: function (targetType, customPageId, showForm) {
            if (customPageId) {
                return Ext.String.format('{0}/custompages/{1}/{2}', this.basePath, targetType, customPageId);
            }
            return Ext.String.format('{0}/custompages_empty/{1}/{2}', this.basePath, targetType, showForm || false);
        },
        getCustomComponentUrl: function (componentType, deviceType, customPageId) {
            if (customPageId && !isNaN(customPageId)) {
                return Ext.String.format('{0}/customcomponents/{1}/{3}', this.basePath, componentType, deviceType, customPageId);
            }
            return Ext.String.format('{0}/customcomponents_empty/{1}/{2}/{3}', this.basePath, componentType, deviceType, customPageId || 'false');
        },
