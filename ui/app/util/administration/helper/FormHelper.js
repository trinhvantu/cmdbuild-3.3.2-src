Ext.define('CMDBuildUI.util.administration.helper.FormHelper', {
     ...
     */
    openLocalizationPopup: function (translationCode, action, localeVmObject, vm, denyAutosave) {
    ...
    showInvalidFieldsMessage: function (invalid) {
        ...
        Ext.Array.forEach(invalid.items, function (item) {
            invalidFields.push(CMDBuildUI.util.administration.helper.FormHelper.getFieldcontainerLabel(item) || Ext.String.capitalize(item.name));
        });
