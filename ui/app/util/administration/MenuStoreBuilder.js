Ext.define("CMDBuildUI.util.administration.MenuStoreBuilder", {
    ...
    appendDomainsAdminMenu: function (index) {
        ...
        CMDBuildUI.util.Stores.loadDomainsStore().then(function (items) {
            var domainsMenu = {
                ...
                leaf: false,
                children: me.getRecordsAsSubmenu(items, CMDBuildUI.model.administration.MenuItem.types.domain, ''),
    ...
    appendViewsAdminMenu: function (index) {
        ...
        CMDBuildUI.util.Stores.loadViewsStore().then(function (items) {
            var filter = {
                ...
                href: Ext.String.format('administration/views_empty/false/{0}', CMDBuildUI.model.views.View.types.filter),
                leaf: false,
                index: 0,
                children: me.getRecordsAsSubmenu(items.filter(function (item) {
            ...
            var sql = {
                ...
                href: Ext.String.format('administration/views_empty/false/{0}', CMDBuildUI.model.views.View.types.sql),
                leaf: false,
                index: 1,
                children: me.getRecordsAsSubmenu(items.filter(function (item) {
            ...
            var schedule = {
                ...
                href: Ext.String.format('administration/views_empty/false/{0}', CMDBuildUI.model.views.View.types.calendar),
                leaf: false,
                index: 2,
                children: me.getRecordsAsSubmenu(items.filter(function (item) {
            ...
            var viewsMenu = {
                ...
                leaf: false,
                children: [filter, sql, schedule, joind]
            };
            deferred.resolve({
                index: index,
                menu: viewsMenu
    ...
    appendCustomPagesAdminMenu: function (index) {
        ...
        CMDBuildUI.util.Stores.loadCustomPagesStore().then(function (items) {
            ...
            var customPagesMenu = {
                ...
                leaf: false,
                href: 'administration/custompages_empty/false',
                children: [customPagesDesktopMenu, customPagesMobileMenu]
            };
            // append menu item to the store if has children
            deferred.resolve({
                index: index,
    ...
    appendCustomComponentsAdminMenu: function (index) {
        ...
        Ext.Promise.all([
            ...
            var contextMenusDesktopMenu = {
                menutype: 'folder',
                index: 0,
                objecttype: CMDBuildUI.model.administration.MenuItem.types.contextmenu,
                text: CMDBuildUI.locales.Locales.administration.common.labels.desktop,
                leaf: false,
                href: CMDBuildUI.util.administration.helper.ApiHelper.client.getCustomComponentUrl(CMDBuildUI.model.administration.MenuItem.types.contextmenu, CMDBuildUI.model.menu.Menu.device['default'], false),
                children: me.getRecordsAsSubmenu(
                    contextMenus.filter(function (item) {
                        return item.get('device') === CMDBuildUI.model.menu.Menu.device['default'];
                    }).sort(me.sortByDescription), CMDBuildUI.model.administration.MenuItem.types.contextmenu, '')
            };
            var contextMenusMobileMenu = {
                menutype: 'folder',
                index: 1,
                objecttype: CMDBuildUI.model.administration.MenuItem.types.contextmenu,
                text: CMDBuildUI.locales.Locales.administration.common.labels.mobile,
                leaf: false,
                href: CMDBuildUI.util.administration.helper.ApiHelper.client.getCustomComponentUrl(CMDBuildUI.model.administration.MenuItem.types.contextmenu, CMDBuildUI.model.menu.Menu.device.mobile, false),
                children: me.getRecordsAsSubmenu(contextMenus.filter(function (item) {
            ...
            var contextMenuFolder = {
                ...
                children: [contextMenusDesktopMenu, contextMenusMobileMenu]
            };
            var widgetDesktopMenu = {
                menutype: 'folder',
                index: 0,
                objecttype: CMDBuildUI.model.administration.MenuItem.types.widget,
                text: CMDBuildUI.locales.Locales.administration.common.labels.desktop,
                leaf: false,
                href: CMDBuildUI.util.administration.helper.ApiHelper.client.getCustomComponentUrl(CMDBuildUI.model.administration.MenuItem.types.widget, CMDBuildUI.model.menu.Menu.device['default'], false),
                children: me.getRecordsAsSubmenu(
                    widgets.filter(function (item) {
                        return item.get('device') === CMDBuildUI.model.menu.Menu.device['default'];
                    }).sort(me.sortByDescription), CMDBuildUI.model.administration.MenuItem.types.widget, '')
            };
            var widgetMenusMobileMenu = {
                menutype: 'folder',
                index: 1,
                objecttype: CMDBuildUI.model.administration.MenuItem.types.widget,
                text: CMDBuildUI.locales.Locales.administration.common.labels.mobile,
                leaf: false,
                href: CMDBuildUI.util.administration.helper.ApiHelper.client.getCustomComponentUrl(CMDBuildUI.model.administration.MenuItem.types.widget, CMDBuildUI.model.menu.Menu.device.mobile, false),
                children: me.getRecordsAsSubmenu(widgets.filter(function (item) {
                    return item.get('device') === CMDBuildUI.model.menu.Menu.device.mobile;
                }).sort(me.sortByDescription), CMDBuildUI.model.administration.MenuItem.types.widget, '')
            };
            var widgetMenuFolder = {
                ...
                // children: me.getRecordsAsSubmenu(widgets.sort(me.sortByDescription), CMDBuildUI.model.administration.MenuItem.types.widget, '')
                children: [widgetDesktopMenu, widgetMenusMobileMenu]
            };
            ...
            CMDBuildUI.util.Stores.loadGroupsStore().then(function (groups) {
                CMDBuildUI.util.Stores.loadMenuNavigationTreesStore().then(function (menuNavTrees) {
                    ...
                    var menuMenu = {
                        ...
                        leaf: false,
                        children: [desktopMenu, mobileMenu, navTreeMenu]
                    };
    ...
    /**
     * 16 - Create new folder for schedule in menu tree
     * @returns {Ext.Deferred} Promise object of {CMDBuildUI.model.menu.MenuItem} 
     */
    ...
    /**
     * 17 - Create new folder for gis in menu tree
     * @returns {Ext.Deferred} Promise object of {CMDBuildUI.model.menu.MenuItem} 
     */
    appendGisAdminMenu: function (index) {
        ...
        var children = [{
            ...
            rowCls: !geoserverEnabled || !gisEnabled ? 'disabled' : '',
            selectable: geoserverEnabled && gisEnabled
        }, {
            menutype: CMDBuildUI.model.administration.MenuItem.types.gis,
            index: 5,
            objecttype: 'gis',
        ...
        var menu = {
            ...
            children: children,
            rowCls: !this.canViewSettings() && !gisEnabled ? 'disabled' : '',
            selectable: this.canViewSettings() || gisEnabled
        };
    ...
    /**
     * 18 - Create new folder for bim in menu tree
     * @returns {Ext.Deferred} Promise object of {CMDBuildUI.model.menu.MenuItem} 
     */
    ...
    /**
     * 19 - Create new folder for language in menu tree
     * @returns {Ext.Deferred} Promise object of {CMDBuildUI.model.menu.MenuItem} 
     */
    ...
    appendImportExportMenu: function (index) {
        ...
        Ext.Promise.all([
            ...
            var gisgates = {
                ...
                leaf: false,
                iconCls: 'x-fa fa-list',
                href: CMDBuildUI.util.administration.helper.ApiHelper.client.getGateTemplateUrl(CMDBuildUI.model.importexports.Gate.gateType.gis)
            };
    ...
    appendSettingsMenu: function (index) {
        ...
        var menu = {
            ...
            children: [{
                ...
                index: 2,
                objecttype: 'setup',
                text: CMDBuildUI.locales.Locales.administration.navigation.passwordpolicy,
                leaf: true,
                iconCls: 'x-fa fa-wrench',
                href: 'administration/setup/passwordpolicy'
            }, {
                menutype: CMDBuildUI.model.administration.MenuItem.types.setup,
                index: 3,
                objecttype: 'setup',
        ...
        for (var i = 0; i < frecords.length; i++) {
            ...
            switch (menutype) {
                ...
                case CMDBuildUI.model.administration.MenuItem.types.custompage:
                    ...
                    menuitem.href = 'administration/custompages/' + record.device + '/' + menuitem.objecttype;
                    break;
                case CMDBuildUI.model.administration.MenuItem.types.dashboard:
                    menuitem.objecttype = record._id;
