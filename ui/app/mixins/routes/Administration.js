Ext.define('CMDBuildUI.mixins.routes.Administration', {
    ...
    showCustompageAdministration_empty: function (device, showForm) {
        var hideForm = (showForm === 'true') ? false : true;
        var customPage = {
    ...
    showDashboardAdministrationView: function (dashboardId) {
        ...
        CMDBuildUI.util.Navigation.addIntoMainAdministrationContent('administration-content-dashboards-view', config);
    },
    showDashboardAdministrationView_empty: function (showForm) {
    ...
    showCustompageAdministrationView: function (targetType, custompageId) {
        CMDBuildUI.util.Navigation.addIntoMainAdministrationContent('administration-content-custompages-view', {
            viewModel: {
                links: {
                    theCustompage: {
    ...
    showCustomcomponentAdministration_empty: function () {
        var nextUrl = CMDBuildUI.util.administration.helper.ApiHelper.client.getCustomComponentUrl('contextmenu', CMDBuildUI.model.menu.Menu.device['default'], false);
        CMDBuildUI.util.administration.MenuStoreBuilder.selectAndRedirectToRecordBy('href', nextUrl, this);
    },
    showCustomcomponentAdministrationView_empty: function (componentType, deviceType, showForm) {
        var hideForm = (showForm === 'true') ? false : true;
        if (!deviceType) {
            var nextUrl = CMDBuildUI.util.administration.helper.ApiHelper.client.getCustomComponentUrl(componentType, CMDBuildUI.model.menu.Menu.device['default'], false);
            CMDBuildUI.util.administration.MenuStoreBuilder.selectAndRedirectToRecordBy('href', nextUrl, this);
            return;
        }
    ...
    showCustompageAdministrationGeneric_empty: function () {
        var nextUrl = CMDBuildUI.util.administration.helper.ApiHelper.client.getCustomPageUrl(CMDBuildUI.model.custompages.CustomPage.device['default']);
        CMDBuildUI.util.administration.MenuStoreBuilder.selectAndRedirectToRecordBy('href', nextUrl, this);
    },
    ...
    showSchedulesAdministrationView_empty: function () {
        var nextUrl = CMDBuildUI.util.administration.helper.ApiHelper.client.getSchedulesUrl();
        CMDBuildUI.util.administration.MenuStoreBuilder.selectAndRedirectToRecordBy('href', nextUrl, this);
    },
    ...
    showViewAdministrationView: function (viewName) {
        ...
        if (store) {
            record = store.findRecord('name', decodeURI(viewName));
        }
    ...
    showJoinViewAdministrationView_empty: function (showForm) {
        ...
        viewModel.links = {
            theView: {
                type: 'CMDBuildUI.model.views.JoinView',
                create: {
    ...
    showJoinViewAdministrationView: function (viewId) {
        ...
        CMDBuildUI.model.views.JoinView.load(viewId, {
            scope: this,
    ...
    showSearchFilterAdministrationView: function (searchfilter) {
        ...
        if (!record) {
            this.showSearchFilterAdministrationView_empty(false);
            return;
        }
        CMDBuildUI.util.Navigation.addIntoMainAdministrationContent('administration-content-viewfilters-form', {
            viewModel: {
