Ext.define('CMDBuildUI.mixins.routes.administration.Permissions', {
    ...
    adminDMSAccess: function () {
        this.onAdminRouteChange();
        var action = arguments[arguments.length - 1];
        this.validateAdminRoutePermission(this.adminRolePrivileges.admin_dms_view, action);
    },
    adminDMSAdd: function () {
        this.onAdminRouteChange();
        var action = arguments[arguments.length - 1];
        this.validateAdminRoutePermission(this.adminRolePrivileges.admin_dms_modify, action);
    },
    ...
    privates: {
        ...
        validateAdminRoutePermission: function (privilege, action, serviceToCheck) {
            var me = this;
            ...
            vm.bind({
                ...
                var theSession = data.theSession;
                var rolePrivilege = theSession.adminCan(privilege, serviceToCheck);
                if (rolePrivilege) {
