...
@Component
@MinionComponent(name = "BIM_ Bimserver client", configBean = BimserverConfiguration.class, canStartStop = true)
public final class BimserverClientServiceImpl implements BimserverClientService {
    ...
    public void uploadIfc(String projectId, DataHandler data, @Nullable String ifcFormat) {
        try {
            ...
            long progress = 0;
            long topicId = client.getServiceInterface().checkinAsync(poid, "", deserializer.getOid(), size, fileName, data, false);
