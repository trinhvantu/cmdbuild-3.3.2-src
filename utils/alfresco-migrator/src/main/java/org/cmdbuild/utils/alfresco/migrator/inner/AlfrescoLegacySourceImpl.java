...
public class AlfrescoLegacySourceImpl implements AlfrescoSource {
    ...
    public void readSourceDocumentInfos(Consumer<AlfrescoSourceDocumentInfo> consumer) {
        try {
            new AlfrescoLegacyQueryHelper(consumer).readSourceDocumentInfos();
    ...
    private class AlfrescoLegacyQueryHelper {
        ...
        private final Consumer<AlfrescoSourceDocumentInfo> consumer;

        public AlfrescoLegacyQueryHelper(Consumer<AlfrescoSourceDocumentInfo> consumer) {
