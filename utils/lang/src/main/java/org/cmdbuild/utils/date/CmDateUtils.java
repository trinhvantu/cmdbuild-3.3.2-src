...
public class CmDateUtils {
    ...
    public static String toIsoDateTimeUtc(@Nullable Object dateTime) {
        if (dateTime == null) {
            ...
            return DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(toDateTime(dateTime).withZoneSameInstant(UTC));
        }
    }
    ...
    public static ZonedDateTime toDateTime(@Nullable Object value) {
        if (value == null) {
            ...
            return ZonedDateTime.ofInstant(((java.sql.Timestamp) value).toInstant(), UTC);
        } else if (value instanceof Date) {
            ...
            return ((LocalTime) value).atDate(ZonedDateTime.now(systemZoneId()).toLocalDate()).atZone(systemZoneId());
        } else {
    ...
    public static Date toJavaDate(@Nullable Object value) {
        if (value == null) {
            ...
            return toJavaDate(((LocalDate) value).atStartOfDay(ZoneOffset.UTC).toInstant().toEpochMilli());
        } else if (value instanceof LocalTime) {
