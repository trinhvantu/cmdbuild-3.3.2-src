...
public class Ws3ResponseHandlerImpl implements Ws3ResponseHandler {
    ...
    public void printResponse(HttpServletResponse response) throws IOException {
        new ResponseBuilderHelper().printResponse(response);
    }

    @Override
    public String getResponseAsString() {
        return new ResponseBuilderHelper().printResponseAsString();
    }

    @Override
    public DataSource getResponseAsDataSource() {
        return new ResponseBuilderHelper().printResponseAsDataSource();
    }

    @Override
    public Map<String, String> getResponseHeaders() {
        return new ResponseBuilderHelper().getHeaders();
    }

    private class ResponseBuilderHelper {
        ...
        private void init() {
            try {
                ...
                if (entity instanceof DataHandler) {
                    entity = CmIoUtils.toDataSource((DataHandler) entity);
                }
                if (entity == null) {
                    status = 204;
                    ...
                    switch (contentType) {
                        case APPLICATION_JSON:
                            ...
                            if (entity instanceof String) {
                                json = ((String) entity).getBytes(StandardCharsets.UTF_8);
                            } else {
        ...
        public void printResponse(HttpServletResponse response) throws IOException {
            getHeaders().forEach(response::setHeader);
        ...
        public String printResponseAsString() {
            try {
        ...
        public DataSource printResponseAsDataSource() {
            try {
                if (streamConsumer != null) {
                    ByteArrayOutputStream out = new ByteArrayOutputStream();
                    streamConsumer.accept(out);
