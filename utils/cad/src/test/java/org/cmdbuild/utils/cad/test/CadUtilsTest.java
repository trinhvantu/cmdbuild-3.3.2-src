...
//        logger.info("georeference info = {}", info);
    ...
    public void testParseDxfToCadEntities2() {
        List<CadEntity> cadEntities = parseDxfFile(getClass().getResourceAsStream("/test_file_2.dxf")).getCadEntities("EPSG:4326");
    ...
    public void testParseDxfToCadEntities2b() {
        List<CadEntity> cadEntities = parseDxfFile(getClass().getResourceAsStream("/test_file_2.dxf")).getCadEntities("EPSG:3857");
        assertFalse(cadEntities.isEmpty());
        cadEntities.forEach(e -> logger.info("found cad entity = {} with metadata = {}", e, mapToLoggableStringInline(e.getMetadata())));
    ...
    public void testParseDxfToCadEntities3() {
        List<CadEntity> cadEntities = parseDxfFile(getClass().getResourceAsStream("/test_file_3.dxf")).getCadEntities("EPSG:4326");
        assertFalse(cadEntities.isEmpty());
        cadEntities.forEach(e -> logger.info("found cad entity = {} with metadata = {}", e, mapToLoggableStringInline(e.getMetadata())));
    }
    ...
    public void testParseDxfToCadEntities4() {
        List<CadEntity> cadEntities = parseDxfFile(getClass().getResourceAsStream("/test_file_4.dxf")).getCadEntities("EPSG:4326");
        assertFalse(cadEntities.isEmpty());
        cadEntities.forEach(e -> logger.info("found cad entity = {} with metadata = {}", e, mapToLoggableStringInline(e.getMetadata())));
    }
    ...
    public void testParseDxfToCadEntities7() {
        List<CadEntity> cadEntities = parseDxfFile(getClass().getResourceAsStream("/test_file_7.dxf")).getCadEntities("EPSG:4326");
        assertFalse(cadEntities.isEmpty());
        cadEntities.forEach(e -> logger.info("found cad entity = {} with metadata = {}", e, mapToLoggableStringInline(e.getMetadata())));
    }
    ...
    public void testParseDxfToCadEntities8() {
        List<CadEntity> cadEntities = parseDxfFile(getClass().getResourceAsStream("/test_file_8.dxf")).getCadEntities("EPSG:4326");
        assertFalse(cadEntities.isEmpty());
        cadEntities.forEach(e -> logger.info("found cad entity = {} with metadata = {}", e, mapToLoggableStringInline(e.getMetadata())));
    }
    ...
    public void testParseDwgToCadEntities2() {
        List<CadEntity> cadEntities = parseDwgFile(getClass().getResourceAsStream("/test_file_2.dwg")).getCadEntities("EPSG:4326");
        assertFalse(cadEntities.isEmpty());
        cadEntities.forEach(e -> logger.info("found cad entity = {} with metadata = {}", e, mapToLoggableStringInline(e.getMetadata())));
    }
    ...
    public void testParseDwgToCadEntities3() {
        List<CadEntity> cadEntities = parseDwgFile(getClass().getResourceAsStream("/test_file_3.dwg")).getCadEntities("EPSG:4326");
        assertFalse(cadEntities.isEmpty());
        cadEntities.forEach(e -> logger.info("found cad entity = {} with metadata = {}", e, mapToLoggableStringInline(e.getMetadata())));
    }
