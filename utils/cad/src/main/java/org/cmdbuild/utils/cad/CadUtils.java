...
public class CadUtils {
    ...
    public static DxfDocument parseCadFile(DataSource file) {
        String contentType = getContentType(file);
        if (isContentType(contentType, "image/vnd.dwg")) {
            return parseDwgFile(file);
        }
        if (isContentType(contentType, "image/vnd.dxf")) {
        ...
        throw new CadException("unable to detect type of cad file = {}", file);
    }
