...
public class HashUtilsTest {
    ...
    public void testToIntHash() {
        assertEquals(114828738, toIntHash(""));
        assertEquals(1793873484, toIntHash("asd"));
        assertEquals(899922750, toIntHash("123"));
        assertEquals(574246528, toIntHash("f2b3h58ifn72i84w3"));
        assertEquals(1064770528, toIntHash("&^%*^%*BV&^B%*&"));
        assertEquals(450912248, toIntHash("qw3vt5w3v"));
        assertEquals(1606506889, toIntHash("wve5yrytrbtgbfthbfthbdrthbdrbtyhetrbyrty"));
        assertEquals(15884065, toIntHash("."));
    }
