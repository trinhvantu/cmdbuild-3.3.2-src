...
import org.cmdbuild.workflow.shark.xpdl.XpdlActivityHolderImpl;
...
public class XpdlProcessIT extends AbstractXpdlIT {
	...
	public void startActivitiesCanBeQueried() {
		...
		final XpdlActivityHolderImpl as2 = xpdlProcess.createActivitySet("AS2");
		...
		final XpdlActivityHolderImpl as23 = xpdlProcess.createActivitySet("AS2.3");
