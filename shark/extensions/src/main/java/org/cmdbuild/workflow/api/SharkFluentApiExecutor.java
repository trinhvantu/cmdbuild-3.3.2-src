...
public class SharkFluentApiExecutor extends ForwardingFluentApiExecutor {
	...
	public SharkFluentApiExecutor(final FluentApiExecutor delegate, final Optional<Long> processId, final SelfSuspensionRequestHolder selfSuspensionRequestHolder) {
