...
public class EtlProcessingResultImpl implements EtlProcessingResult {
    ...
    private final List<EtlProcessingResultError> errors;
    private final EtlProcessingResultDetails details;

    public EtlProcessingResultImpl(ZonedDateTime begin, ZonedDateTime end, long createdRecordCount, long modifiedRecordCount, long unmodifiedRecordCount, long deletedRecordCount, long processedRecordCount, List<EtlProcessingResultError> errors, @Nullable EtlProcessingResultDetails details) {
    ...
    public EtlProcessingResultImpl(long createdRecordCount, long modifiedRecordCount, long unmodifiedRecordCount, long deletedRecordCount, long processedRecordCount, List<EtlProcessingResultError> errors, @Nullable EtlProcessingResultDetails details) {
    ...
    public EtlProcessingResultImpl(long createdRecordCount, long modifiedRecordCount, long unmodifiedRecordCount, long deletedRecordCount, long processedRecordCount, List<EtlProcessingResultError> errors) {
