    ...
    public static WorkbookInfo buildWorkbook(EtlTemplate template, String sheetName) {
        ...
        switch (template.getFileFormat()) {
            case EFF_XLS: {
                ...
                return new WorkbookInfoImpl(workbook, workbook.createSheet(sheetName), "xls", "application/vnd.ms-excel");
            }
            case EFF_XLSX: {
                Workbook workbook = new XSSFWorkbook();
                return new WorkbookInfoImpl(workbook, workbook.createSheet(sheetName), "xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
            }
            default:
