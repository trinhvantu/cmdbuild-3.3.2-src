...
public class SystemApiImpl implements SystemApi {
    ...
    public SystemApiImpl(GlobalConfigService configService, DaoService dao, ApplicationContext applicationContext, CacheService cacheService, LookupService lookupService, ReloadService reloadService) {
