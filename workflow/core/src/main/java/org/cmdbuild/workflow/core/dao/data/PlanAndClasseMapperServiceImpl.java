...
public class PlanAndClasseMapperServiceImpl implements PlanAndClasseMapperService {
    ...
    public PlanAndClasseMapperServiceImpl(PlanServiceDelegateSupplier delegates, EasytemplateProcessor easytemplateProcessor, WorkflowConfiguration configuration, CacheService cacheService, EventBusService eventBusService) {
