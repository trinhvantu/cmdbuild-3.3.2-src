...
//    private final QueryBuilderHelperService processorService = new QueryBuilderHelperServiceImpl(refAttrHelperService, operationUserSupplier, executorService, functionRepository, classeRepository, domainRepository, ecqlService);
    private final QueryBuilderUtilsService utilsService = new QueryBuilderUtilsServiceImpl(() -> mock(LookupRepository.class), domainRepository, classeRepository, operationUserSupplier, functionRepository, refAttrHelperService);
    private final QueryBuilderInnerService processorService = new QueryBuilderInnerServiceImpl(classeRepository, mock(DomainRepository.class), executorService, refAttrHelperService, ecqlService, utilsService, mock(EntryUpdateHelperService.class));
