...
public class ClassMetadataImpl extends EntryTypeMetadataImpl implements ClassMetadata {
    ...
    private final String helpMessage, flowStatusAttr, messageAttr, dmsCategory, validationRule, flowProvider;
    private final Long defaultFilter, defaultExportTemplate;
    ...
    private final CardIdAndClassName defaultImportTemplate;
    ...
    public ClassMetadataImpl(Map<String, String> map) {
        ...
        defaultImportTemplate = parseCardIdAndClassName(toStringOrNull(map.get(DEFAULT_IMPORT_TEMPLATE)), TEMPLATE_TYPE_TEMPLATE);
...
//    }
    ...
    @Override
    @Nullable
    public CardIdAndClassName getDefaultImportTemplateOrNull() {
