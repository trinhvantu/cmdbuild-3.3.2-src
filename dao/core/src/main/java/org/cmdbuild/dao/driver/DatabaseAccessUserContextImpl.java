...
public class DatabaseAccessUserContextImpl implements DatabaseAccessUserContext {
    ...
    private final String username, groupname, sessionId;
    private final DatabaseAccessUserScope scope;

    public DatabaseAccessUserContextImpl(@Nullable String username, @Nullable String groupname, @Nullable String sessionId, boolean ignoreTenantPolicies, @Nullable Set<Long> tenantIdSet, DatabaseAccessUserScope scope) {
    ...
    public DatabaseAccessUserContext withScope(DatabaseAccessUserScope newScope) {
        return new DatabaseAccessUserContextImpl(username, groupname, sessionId, ignoreTenantPolicies, tenantIdSet, newScope);
    }
