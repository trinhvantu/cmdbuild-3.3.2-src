...
public class PatchServiceImpl implements PatchService {
    ...
    public PatchServiceImpl(PatchManager patchManager, ConfigurableDataSource dataSource, FunctionManager functionManager, SystemEventbusService systemEventService, PostgresNotificationEventService postgresNotificationEventService) {
    ...
    private void doApplyPendingPatchesAndFunctions(@Nullable String lastPatch) {
        ...
        try {
            ...
            while (!(avaiblePatches = getAvailableCorePatches()).isEmpty() && (isBlank(lastPatch) || !equal(lastPatch, getLastPatchOnDbKeyOrNull()))) {
