...
public final class DatabaseCreatorConfigImpl implements DatabaseCreatorConfig {
    ...
    private final boolean useLimited, useSharkSchema, createDatabase, keepLocalConfig, installPostgres, skipPatches, vacuumAnalyzeAfterImport;
    ...
    private DatabaseCreatorConfigImpl(Map<String, String> config) {
        ...
        this.useSharkSchema = toBooleanOrDefault(config.get(DATABASE_CONFIG_IMPORT_USE_SHARK_SCHEMA), true);
    ...
    public static class DatabaseCreatorConfigImplBuilder implements Builder<DatabaseCreatorConfig> {
        ...
        public DatabaseCreatorConfigImplBuilder withUseSharkSchema(boolean useSharkSchema) {
            config.put(DATABASE_CONFIG_IMPORT_USE_SHARK_SCHEMA, toStringNotBlank(useSharkSchema));
            return this;
        }
