...
ALTER TABLE "_Filter" ADD CONSTRAINT "_cm3_Shared_check" CHECK ( ( "Shared" = TRUE AND "UserId" IS NULL ) OR ( "Shared" = FALSE AND "UserId" IS NOT NULL ) );
ALTER TABLE "_View" ADD CONSTRAINT "_cm3_Shared_check" CHECK ( ( "Shared" = TRUE AND "UserId" IS NULL ) OR ( "Shared" = FALSE AND "UserId" IS NOT NULL ) );
