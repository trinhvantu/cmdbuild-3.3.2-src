...
$$ LANGUAGE SQL STABLE;
-- -[ RECORD 1 ]--+-----------------------------------------------------------------------------------------------
-- relname        | _cm3_DmsModel_DocumentId
-- relname        | DmsModel
-- indexrelid     | 15936820
-- indrelid       | 15935256
-- indnatts       | 1
...
-- schemaname     | public
-- tablename      | DmsModel
-- indexname      | _cm3_DmsModel_DocumentId
-- tablespace     | 
-- indexdef       | CREATE UNIQUE INDEX "_cm3_DmsModel_DocumentId" ON public."DmsModel" USING btree ("DocumentId")
...
BEGIN
    EXECUTE format($query$DELETE FROM "_Cache" WHERE "Code" = %L; INSERT INTO "_Cache" ("Code", "TimeToLive", "Data") VALUES (%L, %L, (SELECT to_json(array_agg(x))::varchar FROM %I() x))$query$, _code, _code, _ttl, _function::regproc::varchar);
END $$ LANGUAGE PLPGSQL;
...
BEGIN
    IF NOT EXISTS (SELECT * FROM "_Cache" WHERE "Code" = _code) THEN
