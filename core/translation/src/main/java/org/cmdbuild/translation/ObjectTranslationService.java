...
import static org.cmdbuild.translation.TranslationUtils.classContextMenuLabelTranslationCode;
...
public interface ObjectTranslationService {
    ...
    default String translateMenuitemDescription(String code, String defaultValue) {
        return translateByCode(menuitemDescriptionTranslationCode(code), defaultValue);
    }
    ...
    default String translateCalendarTriggerDescription(String triggerId, String defaultValue) {
        return translateByCode(calendarTriggerDescriptionTranslationCode(triggerId), defaultValue);
    }

    default String translateCalendarTriggerContent(String triggerId, String defaultValue) {
        return translateByCode(calendarTriggerContentTranslationCode(triggerId), defaultValue);
    }
    ...
    default String translateClassContextMenuLabel(String className, String contextMenuLabel, String defaultValue) {
        return firstNonNull(translateByCode(classContextMenuLabelTranslationCode(className, contextMenuLabel)), nullToEmpty(defaultValue));
    }
