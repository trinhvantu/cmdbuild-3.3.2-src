...
public class TranslationFromFileUtils {
    ...
    public static List<Translation> loadTranslations(String fileContent) {//TODO improve this  (it is quite frail)
        ...
        JsonNode node = fromJson("{" + checkNotBlank(matcher.group(3)), JsonNode.class);
