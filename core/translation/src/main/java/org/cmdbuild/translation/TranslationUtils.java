...
public class TranslationUtils {
    ...
    public static String menuitemDescriptionTranslationCode(String code) {
        return format("menuitem.%s.description", checkNotBlank(code));
    }
    ...
    public static String dashboardChartDataSourceParameterTranslationCode(String dashboardCode, String chartId, String index) {
        return format("dashboard.%s.charts.%s.dsp.%s.name", checkNotBlank(dashboardCode), checkNotBlank(chartId), checkNotBlank(index));
    }
    ...
    public static String calendarTriggerDescriptionTranslationCode(String triggerId) {
        return format("schedule.%s.description", checkNotBlank(triggerId));
    }

    public static String calendarTriggerContentTranslationCode(String triggerId) {
        return format("schedule.%s.content", checkNotBlank(triggerId));
    }

    public static String classContextMenuLabelTranslationCode(String className, String contextMenuLabel) {
        return format("contextmenu.%s.%s.description", checkNotBlank(className), checkNotBlank(contextMenuLabel));
    }
