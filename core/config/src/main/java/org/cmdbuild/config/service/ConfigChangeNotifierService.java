...
public class ConfigChangeNotifierService {
    ...
    public ConfigChangeNotifierService(SystemService systemStatusService, GlobalConfigService configService, ConfigListenerBeansRepository repository, ApplicationContext applicationContext, SystemEventbusService systemEventService) {
