...
import static org.cmdbuild.audit.ErrorMessagesData.emptyErrorMessagesData;
import static org.cmdbuild.dao.constants.SystemAttributes.ATTR_CODE;
import static org.cmdbuild.dao.constants.SystemAttributes.ATTR_ID;
import org.cmdbuild.dao.orm.annotations.CardAttr;
import org.cmdbuild.eventlog.EventLogRecord;
...
public class EventLogRecordImpl implements EventLogRecord {
    ...
    private final ErrorMessagesData errors;
    ...
    @CardAttr("Errors")
    @Override
    public ErrorMessagesData getErrorsData() {
        return errors;
    }
    ...
    public static class EventLogRecordImplBuilder implements Builder<EventLogRecordImpl, EventLogRecordImplBuilder> {
        ...
        private ErrorMessagesData errors;
        ...
        public EventLogRecordImplBuilder withErrorsData(ErrorMessagesData errors) {
            this.errors = errors;
            return this;
        }
