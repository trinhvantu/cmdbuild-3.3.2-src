...
public class CoreConfigurationImpl implements CoreConfiguration {
    ...
    private FaultEventLevel notificationMessagesLevelThreshold;
    ...
    @ConfigValue(key = "asciiArtBanner", description = "ascii art banner", defaultValue = "pack4yadn48hmnifji7utjzw6hq6f8obub8jr9bwr4qzkg3b58fhcm2xq8fav38tw2jw685ujb716wcbkmqzne70eudf4u23grazlua6lca5wx97awj0ya089g4l00fyulb2h1qs4lb4ezljpg512hbm1kiw3j7k44ftp18e9dqly4z1dzd80p5kcap")
    private String asciiArtBanner;
    ...
    @ConfigValue(key = "chat.enabled", description = "enable chat (experimental feature)", defaultValue = FALSE)
    ...
    @Override
    public String getAsciiArtBanner() {
...
//		checkArgument(getLockCardTimeOut() > getLockCardPersistDelay() * 2, "lock card persist delay should be (quite) less than lock timeout");
    ...
    @Override
    public FaultEventLevel getNotificationMessagesLevelThreshold() {
