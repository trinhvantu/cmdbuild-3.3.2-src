...
public class ReportConfigurationImpl implements ReportConfiguration {
    ...
    @ConfigValue(key = "fonts", description = "font config", defaultValue = "")
    ...
    @ConfigValue(key = "defaultPdfFont", description = "set jasper report config `net.sf.jasperreports.default.pdf.font.name`", defaultValue = "SansSerif")
