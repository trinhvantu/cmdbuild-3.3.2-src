...
public class ContextMenuComponentServiceImpl implements ContextMenuComponentService {
    ...
    public ContextMenuComponentServiceImpl(UiComponentRepository repository) {
    ...
    public UiComponentInfo create(byte[] data) {
        UiComponentData componentData = repository.create(UiComponentDataImpl.builder().withData(data).withName(getCodeFromExtComponentData(data)).withType(UCT_CONTEXTMENU).build());
