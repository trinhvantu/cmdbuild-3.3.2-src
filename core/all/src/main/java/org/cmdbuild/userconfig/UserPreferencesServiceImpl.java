    ...
    public DateAndFormatPreferences getUserPreferences() {
        ...
        TimeZone timezone = Optional.ofNullable(trimToNull(config.get(USER_CONFIG_TIMEZONE))).map(value -> {
            try {
                ...
                logger.error(marker(), "invalid user time zone value =< %s >", value, ex);
                return null;
            }
        ...
        try {
            ...
            logger.error(marker(), "invalid user date format value =< %s >", extjsUserDateFormat, ex);
        }
        try {
            ...
            logger.error(marker(), "invalid user time format value =< %s >", extjsUserTimeFormat, ex);
        }
        try {
        ...
        try {
            ...
            logger.error(marker(), "invalid preferred file charset value =< %s >", config.get(USER_CONFIG_PREFERRED_FILE_CHARSET), ex);
        }
