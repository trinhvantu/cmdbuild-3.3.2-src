...
public class InstanceInfoServiceImpl implements InstanceInfoService {
    ...
    public String getNodeId() {
        return nodeIdProvider.getClusterNodeId();
    }
    ...
    public String getVersion() {
        return versionService.getVersionNumberOrUnknownIfNotAvailable();
    }

    @Override
    public String getRevision() {
        return versionService.getCommitInfoOrUnknownIfNotAvailable();
    }
