...
public class AttributeFilterImpl implements AttributeFilter {
	...
	public static AttributeFilterImpl and(List<AttributeFilter> elements) {
		return new AttributeFilterImpl(AttributeFilterMode.AND, elements, null);
	}

	public static AttributeFilterImpl or(List<AttributeFilter> elements) {
		return new AttributeFilterImpl(AttributeFilterMode.OR, elements, null);
	}
	...
	public CmdbFilter toCmdbFilters() {
		return CmdbFilterImpl.builder().withAttributeFilter(this).build();
	}
