...
import static org.cmdbuild.data.filter.utils.CmdbFilterUtils.expandFulltextFilterForAttrs;
import static org.cmdbuild.data.filter.utils.CmdbFilterUtils.mapNamesInFilter;
import static org.cmdbuild.data.filter.utils.CmdbFilterUtils.mapValuesInFilter;
...
public class CmdbFilterImpl implements CmdbFilter {
    ...
    private CmdbFilterImpl(CmdbFilterBuilder builder) {
        ...
        checkArgument(compositeFilter == null || (attributeFilter == null && relationFilter == null && fulltextFilter == null && cqlFilter == null && ecqlFilter == null && functionFilter == null && attachmentFilter == null), "cannot set both composite filter and any other filter type");
        this.isFalse = false;
    }
