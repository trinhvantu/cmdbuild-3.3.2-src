...
public class EmailUtilsTest {
    ...
    public void testInlineImagesProcessing1() throws MessagingException {
        MimeMessage message = buildMimeMessage("multipart/mixed;boundary=\"_004_AM6PR04MB55104AAC81CD7466F29FFAADF22E0AM6PR04MB5510eurp_\"", "/email_with_embedded_images.raw");
        ...
        assertThat(contentHtml, containsString(" src=\"data:image/png;%20name&#61;&#34;Screenshot%20from%202019-07-08%2010-41-12.png&#34;;base64,iVBORw0KGgoAAAANSUhEUgAA"));
    }
    ...
    public void testInlineImagesProcessing3() throws MessagingException {
        ...
        assertThat(contentHtml, not(containsString(" src=\"cid:")));
        assertThat(contentHtml, containsString(" src=\"data:image/"));
        //TODO test content
    }
