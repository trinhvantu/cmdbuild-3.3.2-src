...
public class DashboardServiceImpl implements DashboardService {
    ...
    @Override
    public boolean isAccessibleByCode(String code) {
        return canRead(repository.getDashboardByCode(code));
    }
    ...
    private boolean canRead(DashboardData dash) {
        return userStore.hasPrivileges(p -> p.hasPrivileges(RolePrivilege.RP_DASHBOARD_ACCESS) || p.hasReadAccess(dash));
    }
