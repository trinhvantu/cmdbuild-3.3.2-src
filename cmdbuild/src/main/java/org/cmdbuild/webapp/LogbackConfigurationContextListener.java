...
import org.cmdbuild.log.LogbackConfigRepositoryImpl;
import org.slf4j.LoggerFactory;
import org.cmdbuild.log.LogbackConfigFileHelper;
import static org.cmdbuild.utils.lang.CmConvertUtils.toBooleanOrDefault;
import org.cmdbuild.log.LogbackConfigRepository;
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        try {
            ...
            if (autoconfigure) {
                ...
                LogbackConfigRepository logbackConfigStore = new LogbackConfigRepositoryImpl(directoryService);
                LogbackConfigFileHelper helper = new LogbackConfigFileHelper(logbackConfigStore, directoryService);

                String config = helper.getConfigFileContentOrDefault();
