    ...
    private class Helper {
        ...
        private void doInner() {
            ...
            try {
                ...
                EtlGate gate = service.getByCodeOrNull(gateCode);
                ...
                switch (context) {
                    case "public":
                        ...
                        break;
                    case "private":
                        checkAuthorized(gate.getAllowPublicAccess() || operationUser.hasPrivileges(p -> p.hasPrivileges(RP_ETLGATE_ALL) || (p.hasPrivileges(RP_ETLGATE_ACCESS) && p.hasReadAccess(gate))), "access denied for gate =< %s >", gate.getCode());
                        break;
                    default:
                ...
                output = service.receive(gate.getCode(), dataSource, mapOf(String.class, String.class).with(
