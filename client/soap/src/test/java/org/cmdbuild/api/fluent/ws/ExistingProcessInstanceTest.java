...
public class ExistingProcessInstanceTest extends AbstractWsFluentApiTest {
	...
	private static final org.cmdbuild.services.soap.client.beans.Workflow PROCESS_INSTANCE_INFO;

	static {
		PROCESS_INSTANCE_INFO = new org.cmdbuild.services.soap.client.beans.Workflow();
