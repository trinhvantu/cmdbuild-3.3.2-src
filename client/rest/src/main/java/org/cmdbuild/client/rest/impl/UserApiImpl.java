...
public class UserApiImpl extends AbstractServiceClientImpl implements UserApi {
    ...
    @Override
    public RoleInfo createRole(String rolename) {
        JsonNode data = post("roles", map("name", checkNotBlank(rolename))).asJackson().get("data");
    ...
    @Override
    public UserApi setRolePrivilegesOnClass(String rolename, String classId, GrantMode mode) {
