...
public class AnnotatedMethodJobSource implements JobSource, JobRunner {
    ...
    public AnnotatedMethodJobSource(AnnotatedMethodJobSupplier annotatedMethodJobSupplier, ApplicationContext applicationContext, GlobalConfigService configService) {
