...
public class CalendarEventEmailWs {
    ...
    private final EmailWsHelper emailSerialization;
    ...
    public CalendarEventEmailWs(EmailService emailService,
        ...
        this.emailSerialization = checkNotNull(emailSerialization);
        this.attachmentHelper = checkNotNull(attachmentHelper);
    }

    @POST
    @Path(EMPTY)
    public Object create(@PathParam("eventId") Long eventId, @QueryParam("apply_template") @DefaultValue(FALSE) Boolean applyTemplate, @QueryParam("template_only") @DefaultValue(FALSE) Boolean templateOnly, @QueryParam("attachments") List<String> tempId, List<Attachment> parts) {
        ...
        return response(emailSerialization.createEmail(EVENT_TABLE, eventId.toString(), emailData, applyTemplate, templateOnly, emailAttachments));
    }
    ...
    public Object update(@PathParam("eventId") Long eventId, @PathParam("emailId") Long emailId, WsEmailData emailData) {
        ...
        return response(serializeDetailedEmail(email, null));
    }
