...
public class DomainWs {
            ...
            domains = AttributeFilterProcessor.<Domain>builder()
                    .withKeyToValueFunction((key, domain) -> {
                        switch (key) {
                            ...
                            case "cardinality":
                                return serializeDomainCardinality(((Domain) domain).getCardinality());
                            default:
    ...
    public static class WsDomainData {
        ...
        private final Boolean inline1, defaultClosed1, inline2, defaultClosed2, cascadeActionDirectAskConfirm, cascadeActionInverseAskConfirm;
        private final List<String> disabledSourceDescendants, disabledDestinationDescendants, masterDetailAggregateAttrs;
