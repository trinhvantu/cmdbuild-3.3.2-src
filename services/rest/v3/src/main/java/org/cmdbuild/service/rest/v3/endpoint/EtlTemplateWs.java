...
public class EtlTemplateWs {
    ...
    public Object readOne(@PathParam("templateId") String idOrCode) {
        EtlTemplate template = service.getForUserByIdOrCode(idOrCode);
    ...
    @Path("{templateId}/")
    @RolesAllowed(ADMIN_ETL_MODIFY_AUTHORITY)
    public Object update(@PathParam("templateId") Long templateId, WsEtlTemplateData data) {
    ...
    public static FluentMap serializeDetailedTemplate(EtlTemplate template) {
        return serializeBasicTemplate(template).with(
                ...
                "errorEmailTemplate", template.getErrorTemplate(),
                "notificationEmailTemplate", template.getNotificationTemplate(),
                "errorEmailAccount", template.getErrorAccount(),
    ...
    public static class WsEtlTemplateData {
        ...
        private final Long errorEmailTemplate, errorEmailAccount, notificationEmailTemplate;
        private final String code, description, targetName, exportFilter, mergeModeUpdateAttr, mergeModeUpdateValue, csvSeparator, importKeyAttribute, source, charset;
        ...
        public WsEtlTemplateData(
                ...
                @JsonProperty("notificationEmailTemplate") Long notificationEmailTemplate,
                ...
                @JsonProperty("importKeyAttributes") List<String> importKeyAttributes,
                ...
                @JsonProperty("alwaysHandleMissingRecords") Boolean alwaysHandleMissingRecords,
        ...
        public EtlTemplateImplBuilder toImportExportTemplate() {
            return EtlTemplateImpl.builder()
                    ...
                    .withErrorAccount(errorEmailAccount)
                    .withErrorTemplate(errorEmailTemplate)
                    .withNotificationTemplate(notificationEmailTemplate)
                    ...
                    .withAlwaysHandleMissingRecords(alwaysHandleMissingRecords)
