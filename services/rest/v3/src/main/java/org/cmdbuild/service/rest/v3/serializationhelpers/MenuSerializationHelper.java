            ...
            return map(
                ...
                if (forUser) {
                    m.put(
                            ...
                            "_objectDescription_translation", item.hasOwnDescription() ? translationService.translateMenuitemDescription(item.getCode(), item.getDescription()) : getTargetDescriptionTranslation(item.getType(), item.getTarget(), item.getTargetDescription())
                    );
                } else {
                    m.put(
                            "objectDescription", item.getDescription(),
                            "_objectDescription_translation", translationService.translateMenuitemDescription(item.getCode(), item.getDescription()),
                            "_actualDescription", item.getActualDescription(),
                            "_actualDescription_translation", item.hasOwnDescription() ? translationService.translateMenuitemDescription(item.getCode(), item.getDescription()) : getTargetDescriptionTranslation(item.getType(), item.getTarget(), item.getTargetDescription()),
