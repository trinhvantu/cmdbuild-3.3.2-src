...
public class FunctionsWs {
    ...
    private Object serializeParam(Attribute param, String functionId) {
        return map(attributeTypeConversionService.serializeAttributeType(param)).with(
                "_description_translation", translationService.translateFunctionAttributeDescription(functionId, param.getName(), param.getName())
        );
    }
