...
public class JobsWs {
    ...
    @GET
    @Path("{jobId}/runs")
    public Object getJobRunsForJob(@PathParam("jobId") String jobId, @QueryParam(START) Long offset, @QueryParam(LIMIT) Long limit) {
    ...
    @GET
    @Path("{jobId}/errors")
    public Object getJobRunErrorsForJob(@PathParam("jobId") String jobId, @QueryParam(START) Long offset, @QueryParam(LIMIT) Long limit) {
