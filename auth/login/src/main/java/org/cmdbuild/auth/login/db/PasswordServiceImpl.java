...
public class PasswordServiceImpl implements PasswordService {
    ...
    public void verifyAndUpdatePasswordForUser(String username, String oldpassword, String password) {
        ...
        PasswordCheckResult result = checkPasswordForUser(LoginUserIdentity.build(username), oldpassword);
    ...
    @Override
    public PasswordCheckResult checkPasswordForUser(LoginUserIdentity login, String password) {
        return authenticator.isPasswordValid(login, password);
    }
