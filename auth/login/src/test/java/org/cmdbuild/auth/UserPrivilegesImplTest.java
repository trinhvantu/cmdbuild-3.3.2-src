...
public class UserPrivilegesImplTest {
    ...
    public void testUserPrivilegesBuilder3() {
        ...
        assertEquals(true, privilegesForObject.getMaxPrivilegesForSomeRecords().getCustomPrivileges().get("custom"));
        assertEquals(true, getOnlyElement(privilegesForObject.getPrivilegeGroupsWithFilter()).getCustomPrivileges().get("custom"));
        assertEquals(true, privilegesForObject.getMinPrivilegesForAllRecords().getCustomPrivileges().get("custom"));
