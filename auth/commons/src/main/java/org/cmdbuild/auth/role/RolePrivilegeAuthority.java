...
public class RolePrivilegeAuthority {
    ...
    public static final String CARD_TAB_ATTACHMENT_ACCESS_AUTHORITY = "ROLE_CARD_TAB_ATTACHMENT_ACCESS";
    public static final String CARD_TAB_DETAIL_ACCESS_AUTHORITY = "ROLE_CARD_TAB_DETAIL_ACCESS";
    public static final String CARD_TAB_EMAIL_ACCESS_AUTHORITY = "ROLE_CARD_TAB_EMAIL_ACCESS";
    public static final String CARD_TAB_HISTORY_ACCESS_AUTHORITY = "ROLE_CARD_TAB_HISTORY_ACCESS";
    public static final String CARD_TAB_NOTE_ACCESS_AUTHORITY = "ROLE_CARD_TAB_NOTE_ACCESS";
    public static final String CARD_TAB_RELATION_ACCESS_AUTHORITY = "ROLE_CARD_TAB_RELATION_ACCESS";
    public static final String CARD_TAB_SCHEDULE_ACCESS_AUTHORITY = "ROLE_CARD_TAB_SCHEDULE_ACCESS";
    public static final String FLOW_TAB_ATTACHMENT_ACCESS_AUTHORITY = "ROLE_FLOW_TAB_ATTACHMENT_ACCESS";
    public static final String FLOW_TAB_DETAIL_ACCESS_AUTHORITY = "ROLE_FLOW_TAB_DETAIL_ACCESS";
    public static final String FLOW_TAB_EMAIL_ACCESS_AUTHORITY = "ROLE_FLOW_TAB_EMAIL_ACCESS";
    public static final String FLOW_TAB_HISTORY_ACCESS_AUTHORITY = "ROLE_FLOW_TAB_HISTORY_ACCESS";
    public static final String FLOW_TAB_NOTE_ACCESS_AUTHORITY = "ROLE_FLOW_TAB_NOTE_ACCESS";
    public static final String FLOW_TAB_RELATION_ACCESS_AUTHORITY = "ROLE_FLOW_TAB_RELATION_ACCESS";
