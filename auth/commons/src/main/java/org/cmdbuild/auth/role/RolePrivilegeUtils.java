...
import static org.cmdbuild.auth.role.RolePrivilege.RP_CARD_TAB_SCHEDULE_ACCESS;
...
public class RolePrivilegeUtils {
    ...
    private static final PrivilegeProcessor<RolePrivilege> ROLE_PRIVILEGE_PROCESSOR = PrivilegeProcessorImpl.<RolePrivilege>builder().withPrivilegeImplicationMap(map(RP_ADMIN_ALL, set(
            RP_ADMIN_ALL_READONLY, RP_SYSTEM_ACCESS, RP_DATA_ALL_WRITE, RP_DATA_ALL_TENANT, RP_PROCESS_ALL_EXEC, RP_IMPERSONATE_ALL, RP_ETLGATE_ALL,
            ...
            RP_ADMIN_UICOMPONENTS_MODIFY, RP_ADMIN_CALENDAR_MODIFY, RP_ADMIN_ETL_MODIFY),
            RP_ADMIN_ALL_READONLY, set(RP_ADMIN_ACCESS, RP_DATA_ALL_READ,
                    ...
                    RP_ADMIN_UICOMPONENTS_VIEW, RP_ADMIN_CALENDAR_VIEW, RP_ADMIN_ETL_VIEW),
            RP_BASE_ALL, set(RP_BASE_ACCESS, RP_BULKUPDATE_ACCESS, RP_CHANGEPASSWORD_ACCESS, RP_CLASS_ACCESS, RP_CUSTOMPAGES_ACCESS, RP_DASHBOARD_ACCESS, RP_DATAVIEW_ACCESS, RP_EXPORTCSV_ACCESS,
                    ...
                    RP_CARD_TAB_ATTACHMENT_ACCESS, RP_CARD_TAB_DETAIL_ACCESS, RP_CARD_TAB_EMAIL_ACCESS, RP_CARD_TAB_HISTORY_ACCESS, RP_CARD_TAB_NOTE_ACCESS, RP_CARD_TAB_RELATION_ACCESS, RP_CARD_TAB_SCHEDULE_ACCESS,
                    RP_FLOW_TAB_ATTACHMENT_ACCESS, RP_FLOW_TAB_DETAIL_ACCESS, RP_FLOW_TAB_EMAIL_ACCESS, RP_FLOW_TAB_HISTORY_ACCESS, RP_FLOW_TAB_NOTE_ACCESS, RP_FLOW_TAB_RELATION_ACCESS, RP_ETLGATE_ACCESS),
            ...
            RP_ADMIN_CLASSES_VIEW, set(RP_ADMIN_DOMAINS_VIEW, RP_ADMIN_CALENDAR_VIEW, RP_ADMIN_LOOKUPS_VIEW, RP_ADMIN_ETL_VIEW),
            RP_ADMIN_PROCESSES_VIEW, set(RP_ADMIN_JOBS_VIEW, RP_ADMIN_DOMAINS_VIEW, RP_ADMIN_LOOKUPS_VIEW, RP_ADMIN_ETL_VIEW),
            RP_ADMIN_DOMAINS_VIEW, set(RP_ADMIN_CLASSES_MODIFY, RP_ADMIN_DOMAINS_VIEW, RP_ADMIN_LOOKUPS_VIEW),
            RP_ADMIN_VIEWS_VIEW, set(RP_ADMIN_CLASSES_MODIFY, RP_ADMIN_PROCESSES_VIEW),
            ...
            RP_ADMIN_ROLES_VIEW, set(RP_ADMIN_CLASSES_VIEW, RP_ADMIN_PROCESSES_VIEW, RP_ADMIN_VIEWS_VIEW, RP_ADMIN_DASHBOARDS_VIEW, RP_ADMIN_REPORTS_VIEW, RP_ADMIN_UICOMPONENTS_VIEW, RP_ADMIN_ETL_VIEW),
            RP_ADMIN_USERS_VIEW, set(RP_ADMIN_CLASSES_VIEW, RP_ADMIN_PROCESSES_VIEW, RP_ADMIN_VIEWS_VIEW, RP_ADMIN_DASHBOARDS_VIEW, RP_ADMIN_REPORTS_VIEW, RP_ADMIN_UICOMPONENTS_VIEW),
            ...
            RP_ADMIN_GIS_VIEW, set(RP_ADMIN_CLASSES_MODIFY, RP_ADMIN_DOMAINS_VIEW),
            RP_ADMIN_SEARCHFILTERS_VIEW, set(RP_ADMIN_CLASSES_MODIFY, RP_ADMIN_PROCESSES_VIEW)
    )).build();
