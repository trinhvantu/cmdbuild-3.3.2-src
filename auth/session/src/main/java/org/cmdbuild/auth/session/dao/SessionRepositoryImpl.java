...
public class SessionRepositoryImpl implements SessionRepository {
    ...
    public SessionRepositoryImpl(MultitenantService multitenantService, EventBusService grantEventService, SessionDataRepository repo, CoreConfiguration configuration, AuthenticationService authenticationService, CacheService cacheService, RequestContextService requestContextService, RoleRepository groupRepository) {
        logger.info("init");
